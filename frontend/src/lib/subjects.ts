...
export const SUBJECT_INFO: Record<string, SubjectInfo> = {
  ...
  'Riwaya na Tamthilia':    { name: 'Riwaya na Tamthilia',     color: '#7c2d12', bg: '#fff7ed', description: 'Novels and Plays — Kiswahili Literature',           image: 'https://images.unsplash.com/photo-1516979187457-637abb4f9353?w=400&q=75' },
  'Novel and Plays':        { name: 'Novel and Plays',         color: '#1e3a8a', bg: '#eff6ff', description: 'English Novels, Plays and Literature',              image: 'https://images.unsplash.com/photo-1495640388908-05fa85288e61?w=400&q=75' },
  'Maswali ya Mtihani':     { name: 'Maswali ya Mtihani',      color: '#374151', bg: '#f9fafb', description: 'Past Papers — NECTA and Mock Exams',               image: 'https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=400&q=75' },
};
